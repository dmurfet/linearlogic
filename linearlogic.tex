...
\begin{theorem} Any recursive function $\mathbb{N} \lto \mathbb{N}$ which is provably total in second-order Peano arithmetic can be encoded into second-order linear logic as a proof of $\inta \vdash \inta$.
\end{theorem}
\begin{proof}
